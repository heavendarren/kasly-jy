 ...
 *
 */
package de.platform.kaslyjy.fulfilmentprocess.test.jobs;
...
import de.platform.kaslyjy.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = KaslyjyFulfilmentProcessConstants.ORDER_PROCESS_NAME;
