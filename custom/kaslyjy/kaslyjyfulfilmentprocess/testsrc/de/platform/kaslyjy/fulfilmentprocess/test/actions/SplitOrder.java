 ...
 *
 */
package de.platform.kaslyjy.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(KaslyjyFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(KaslyjyFulfilmentProcessConstants.PARENT_PROCESS);
