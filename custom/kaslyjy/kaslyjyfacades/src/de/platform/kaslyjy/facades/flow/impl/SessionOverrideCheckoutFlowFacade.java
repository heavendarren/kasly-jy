 ...
 *
 */
package de.platform.kaslyjy.facades.flow.impl;
...
public class SessionOverrideCheckoutFlowFacade extends DefaultCheckoutFlowFacade
{
	...
	public CheckoutFlowEnum getCheckoutFlow()
	{
		...
		if (getCurrentUserForCheckout().getType() != null && getCurrentUserForCheckout().getType().equals(CustomerType.valueOf(CustomerType.GUEST.getCode())))
		{
