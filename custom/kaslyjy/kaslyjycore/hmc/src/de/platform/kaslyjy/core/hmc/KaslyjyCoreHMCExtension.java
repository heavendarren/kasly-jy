 ...
 *
 */
package de.platform.kaslyjy.core.hmc;
...
/**
 * Provides necessary meta information about the kaslyjycore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class KaslyjyCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(KaslyjyCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.platform.kaslyjy.core.hmc.locales";
