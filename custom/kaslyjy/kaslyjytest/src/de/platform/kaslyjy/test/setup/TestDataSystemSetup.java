 ...
 *
 */
package de.platform.kaslyjy.test.setup;
...
import de.platform.kaslyjy.test.constants.KaslyjyTestConstants;
import de.platform.kaslyjy.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = KaslyjyTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/kaslyjytest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/kaslyjytest/import/reviews.impex");
			...
			importImpexFile(context, "/kaslyjytest/import/cstickets.impex");
		}
	}
}
