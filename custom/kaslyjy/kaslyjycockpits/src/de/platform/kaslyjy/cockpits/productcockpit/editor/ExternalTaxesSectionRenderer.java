 ...
 *
 */
package de.platform.kaslyjy.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("kaslyjycockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("kaslyjycockpits.product.externalTaxes"));
